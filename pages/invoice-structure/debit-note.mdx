...
|-----------------------|:------------:|-----------------------------------|
|[cbc:ID](./debit-note/id.mdx) |	[1..1] |Unique identifier for the debit-note.|
|[cbc:IssueDate](./debit-note/issue-date.mdx) |	[1..1] |Invoice issue date.
|[cbc:Note](./debit-note/note.mdx) | [1..1] |   Contain reasons for Credit Note and Debit Note.
|[cbc:BillingReference](./debit-note/billing-reference.mdx) | [1..1] | A reference to a billing document associated with this document.
|[cac:AdditionalDocumentReference](./debit-note/additional-document-reference) | [0..n] |  A reference to an additional document associated with this document.  
|[cbc:DocumentCurrencyCode](./debit-note/document-currency-code.mdx) |	[1..1]	|The currency in which the debit-note is denominated.
|[cac:AccountingSupplierParty](./debit-note/accounting-supplier-party.mdx) |	[1..1] |	Party supplying the goods or services in the debit-note.
|[cac:AccountingCustomerParty](./debit-note/accounting-customer-party.mdx) |	[1..1] |	Party to whom the goods or services are supplied.
|[cac:PaymentTerms](./debit-note/payment-terms.mdx) | [0..1] | The terms and conditions of a payment agreement. |
|[cac:AllowanceCharge](./debit-note/allowance-charge.mdx) |	[0..n] |	A discount or charge that applies to the debit-note on document level.
|[cac:TaxExchangeRate](./debit-note/tax-exchange-rate.mdx) |	[0..1] |	Exchange rate applied for tax calculation in debit-notes involving conversion, mandatory if document currency is not Khmer Riel(KHR).
|[cac:TaxTotal](./debit-note/tax-total.mdx) |	[1..1] |		Total tax amount for each specific tax.
|[cac:RequestedMonetaryTotal](./debit-note/requested-monetary-total.mdx) | [1..1] |	Total amounts for the debit-note.
|[cac:DebitNoteLine](./debit-note/debit-note-line.mdx) |	[1..n] |	Each individual line item of the debit-note.
