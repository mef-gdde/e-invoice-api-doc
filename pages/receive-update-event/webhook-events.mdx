...
You will receive the event vai POST request to the webhook URL the was set on Merchant Portal Setting

## Doucument SENT Event
This Event was triggered when the document was trigger send to customer

## Webhook Event Payload

| Field              | Description                                          |
|--------------------|------------------------------------------------------|
| type               | The [type of event](/data-type/event-type).                                   |
| document_id        | The unique identifier of the document.               |
| verification_link  | The verification link for the document.              |
| document           | The document associated with the event.              |
| document_hash      | The hash of the document for verification purposes.  |
...
```json
{
    ...
    "verification_link": "https://example.com/verification?data=df5dcf78-e78b-4396-87bb-2d2a44c1302e",
...
This Event was triggered when the document send & validated
For this event you are as the receiver for the document
## Webhook Event Payload
