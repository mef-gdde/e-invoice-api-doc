...
| [cbc:InvoicedQuantity](./invoice-line/invoiced-quantity.mdx)  |   [0..1]   | The quantity (of items) on this invoice line. |
...
| [cac:TaxTotal](./invoice-line/tax-total.mdx)                  |   [0..*]   | A total amount of taxes of a particular kind applicable to this invoice line. |
