...
- [Getting Started](./getting-started/overview): A guide to help you begin your integration with CamInvoice.
- [API Reference](./api-reference/authentication): Detailed information about our API endpoints.
- [Invoice Structure](./invoice-structure/invoice): Specifications on the required formats for invoices and debit/credit notes.
- [Receive Update Event](./receive-update-event/webhook): Information on how to configure and use webhooks for receiving notifications.
- [Document Type](./data-type/document-type): Details on the various document types supported by CamInvoice.

## How It Works

![](./workflow.png)

As illustrated above, when a CamInvoice user generates an XML e-invoice using their system or our Free E-invoice Portal, they must send the invoice to CamInvoice via our API.
